...
public class Selected_cartdata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(Selected_cartdata.this)

                .load("http://demoproject.in"+ selectcart_prod.getSel_cartprod_imagepath())
