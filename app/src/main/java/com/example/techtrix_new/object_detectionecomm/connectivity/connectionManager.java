...
public class connectionManager {
   ...
   /* public static String ServiceUrl="http://192.168.1.38/Bamboo_service/Service1.svc";*/

    public static String ServiceUrl="http://demoproject.in/bamboo_service/Service1.svc";
        ...
        try {
            ...
            if (statusLine.getStatusCode() == HttpStatus.SC_OK) {
                ...
                for (int i = 0; i < jarrayobj.length(); i++) {
                    ...
                    product_imagepath.add(prod_imagepath.toString().trim());
    ...
    public int buy_product() {
        try {
           ...
           /* jsonObject.accumulate("categoryid",buy_product.getBuy_catid());*/
            jsonObject.accumulate("categoryid",Category_data.getSelect_category());
    ...
    public boolean SeeCart()
    {
        ...
        try
        {
            ...
            final String TAG_categoryid="Category_id";
            ...
            if(statusLine.getStatusCode() == HttpStatus.SC_OK)
            {
                ...
                for(int i=0;i<newJsonArray.length();i++)
                {
                    ...
                    String category_id=jsonObj.optString(TAG_categoryid);
                ...
                Cartlistdata.setCategoryId_(stringarray7);
               return true;
            }
            else
            {
